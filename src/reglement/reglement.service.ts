...
export class ReglementService {
  ...
  //     id_caisse,
  //     id_compte,
  //     id_commande_vente, // Ajouté : ID optionnel de la facture spécifique à régler en priorité
  //   } = createReglementDto;
  ...
  //   // Si un id_commande_vente spécifique est fourni, le prioriser
  //   if (id_commande_vente) {
  //     const factureSpecifique = factures.find(
  //       (f) => f.id_commande_vente.toString() === id_commande_vente,
  //     );
  //     if (!factureSpecifique) {
  //       throw new BadRequestException(
  //         `Facture avec l'ID ${id_commande_vente} non trouvée ou déjà réglée pour ce client`,
  //       );
  //     }

  //     // Réorganiser la liste pour mettre la facture spécifique en premier
  //     const index = factures.indexOf(factureSpecifique);
  //     if (index > -1) {
  //       factures.splice(index, 1);
  //       factures.unshift(factureSpecifique);
  //     }

  //     console.log(`Facture ${id_commande_vente} priorisée pour le règlement.`);
  //   }
  ...
  //     id_caisse,
  //     id_compte,
  //     id_commandes_vente, // Modifié : Tableau optionnel des IDs des factures à régler en priorité
  //   } = createReglementDto;
  ...
  //   // Si des id_commandes_vente spécifiques sont fournis, les prioriser
  //   let prioritizedFactures = [...factures];
  //   if (id_commandes_vente && id_commandes_vente.length > 0) {
  //     const facturesSpecifiques = factures.filter((f) =>
  //       id_commandes_vente.includes(f.id_commande_vente.toString()),
  //     );
  //     if (facturesSpecifiques.length !== id_commandes_vente.length) {
  //       const missingIds = id_commandes_vente.filter(
  //         (id) => !factures.some((f) => f.id_commande_vente.toString() === id),
  //       );
  //       throw new BadRequestException(
  //         `Certaines factures spécifiées (${missingIds.join(', ')}) n'existent pas ou sont déjà réglées pour ce client`,
  //       );
  //     }

  //     // Réorganiser la liste pour mettre les factures spécifiques en premier, dans l'ordre fourni
  //     prioritizedFactures = [
  //       ...facturesSpecifiques.sort(
  //         (a, b) =>
  //           id_commandes_vente.indexOf(a.id_commande_vente.toString()) -
  //           id_commandes_vente.indexOf(b.id_commande_vente.toString()),
  //       ),
  //       ...factures.filter(
  //         (f) => !id_commandes_vente.includes(f.id_commande_vente.toString()),
  //       ),
  //     ];

  //     console.log(
  //       `Factures ${id_commandes_vente.join(', ')} priorisées pour le règlement.`,
  //     );
  //   }
